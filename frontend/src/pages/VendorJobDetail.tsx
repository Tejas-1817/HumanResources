    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 pb-12">
      <div className="flex items-center gap-3 sm:gap-4">
        <button
          ...
          className="p-2.5 rounded-xl bg-secondary hover:bg-secondary/80 transition-all text-muted-foreground shadow-sm shrink-0"
        >
          <ArrowLeft className="w-5 h-5" />
        </button>
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground tracking-tight truncate">{job.title}</h1>
          <p className="text-[9px] sm:text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-black opacity-60 truncate">Intelligence Hub / Job Role Information</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          <div className="glass-card p-4 sm:p-6 border border-border/50 bg-card shadow-sm">
            <div className="flex flex-wrap gap-2.5 sm:gap-3 mb-6 pb-5 border-b border-border/50">
              {job.location && (
          ...
          <div className="glass-card p-4 sm:p-6 border border-border/50 bg-card shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 sm:mb-8">
              <div>
                <h3 className="text-base sm:text-lg font-bold text-foreground">My Submissions</h3>
              ...
              <Link
                ...
                className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-primary text-primary-foreground text-[10px] font-black uppercase tracking-widest hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-xl shadow-primary/20"
              >
